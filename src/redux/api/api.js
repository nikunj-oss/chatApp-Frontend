...
const api=createApi({
    ...
    //do caching so we dont have to fetch data each and every time
    tagTypes:["Chat","User","Message"],
    endpoints:(builder)=>({
        //it has 2 options query and mutation query for get request and mutations for put/post request
